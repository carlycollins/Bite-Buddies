...
export const router = createHashRouter(
  [
    ...
    { path: '/scan-pantry', Component: ScanPantry },
    { path: '/meal-selection', Component: MealSelection },
    { path: '/weekly-meal-plan', Component: WeeklyMealPlan },
    { path: '/meal-prep/:id', Component: MealPrepInstructions },
    { path: '/grocery-filters', Component: GroceryFilters },
    { path: '/store-list', Component: StoreList },
    { path: '/grocery-list', Component: GroceryList },
    { path: '/my-pantry', Component: MyPantry },
    { path: '/my-meal-plan', Component: MyMealPlan },
    { path: '/my-groceries', Component: MyGroceries },
